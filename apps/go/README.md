...
## Prompt Ladder (Copilot Chat)

Use these progressively (do not skip a level until finished). Copy & paste one prompt at a time into Copilot Chat.

Tip: Include the file `specs.md` for context along with `main.go` when using Copilot Chat.
